...
namespace Working_with_Web_Server
{
    public partial class Bai4 : Form
    {
        ...
        {
            tbURL.Text = webView.Source.AbsoluteUri;
        }
        ...
        private async void button2_Click(object sender, EventArgs e)
        {
            ...
            string folderPath = @"C:\Users\gialinh\source\repos\NT106 LAP TRINH MANG CAN BAN\LAB4\download"; // Đổi đường dẫn thư mục tải về ở đây
